        ...
        <div className='flex justify-between items-center'>
          <input type="text" placeholder='search By Emp ID' onChange={filterByInput}  className='px-4 py-0.5 border'/>
            <div className='space-x-3'>
                <button className='px-2 py-1 bg-yellow-600 text-white hover:bg-yellow-700 rounded-3xl'
                        onClick={() => filterByButton("Pending")}>Pending</button>
                <button className='px-2 py-1 bg-green-600 text-white hover:bg-green-700 rounded-3xl'
                        onClick={() => filterByButton("Approved")}>Approved</button>
                <button className='px-2 py-1 bg-red-600 text-white hover:bg-red-700 rounded-3xl'
